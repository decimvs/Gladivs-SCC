...
public class MainController implements Initializable {
    ...
    @FXML
    private MenuItem mnitKeyboardSettings, mnitLangEnglish, mnitLangSpanish, mnitLangCatalan, mnitLangFrench;
    @FXML
    ...
    public void takeScreenshotButtonActionPerformed()
    {
        ...
        if(!mApp.getMainStage().isShowing()) mApp.getMainStage().show();
    }
    ...
    {     
        if(checkForUpdates == 1){
            ...
            try {
                ...
                if(latest.getLatest_version().equals(mApp.APP_VERSION))
                {
